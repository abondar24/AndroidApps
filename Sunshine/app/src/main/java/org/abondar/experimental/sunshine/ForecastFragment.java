...
public class ForecastFragment extends Fragment {
    ...
    public class FetchWeatherTask extends AsyncTask<String, Void, String[]> {
        ...
        private String formatHighLows(double high, double low, String unitType) {
            ...
            if (unitType.equals(getString(R.string.settings_units_imperial))) {
                high = (high * 1.8) + 32;
                low = (low * 1.8) + 32;
            } else if (!unitType.equals(getString(R.string.settings_units_metric))) {
        ...
        private String[] getWeatherDataFromJson(String forecastJson, int numDays) throws JSONException {
            ...
            JSONArray weatherArray = forecast.getJSONArray(OWM_LIST);
